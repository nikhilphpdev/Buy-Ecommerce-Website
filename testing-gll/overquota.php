    ...
    if(mysqli_num_rows($queyer_val)){
       ...
       //echo $getip;
        ...
        if($finaltime < $getvaluetime){
            //echo "ok";
            $insertvale = mysqli_query($con,"UPDATE project_status SET p_status_s_ip='$ip',p_status_e_time='$link_time',p_status_final_st='3',p_status_clint_id='$getvalue',p_status_url_use='0' WHERE p_status_own_id='$project_id' AND p_status_uid='$uid_id' AND p_status_url_use='1'");
            ...
            //echo "no";
            $insertvale = mysqli_query($con,"UPDATE project_status SET p_status_s_ip='$ip',p_status_e_time='$link_time',p_status_final_st='3',p_status_clint_id='$getvalue',p_status_url_use='2' WHERE p_status_own_id='$project_id' AND p_status_uid='$uid_id' AND p_status_url_use='1'");
            echo "Time Issue.";
        }
    }else{
