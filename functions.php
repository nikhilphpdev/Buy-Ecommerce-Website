		              ...
		              <div class='item-txt'>
		                ...
		                if($rowvenderrightprodt['product_regular_price'] == "0" || $rowvenderrightprodt['product_regular_price'] == ""){
		                	...
		                	if($rowvenderrightprodt['product_sale_price'] == ""){
		                        ...
		                        echo "<div class='item-price'><div class='pric_dis'><span>$</span>".number_format($rowvenderrightprodt['product_regular_price'], 2)."</div> <div class='pric_reg'><span>$</span>".number_format($rowvenderrightprodt['product_sale_price'], 2)."</div>";
		                        echo "</div>";
		                      }
		                ...
		                if($attbutvalcolor == "" || $attbutvalcolor == "0"){
		                	...
		                	if($rowprodtfechdata['product_sale_price'] == ""){
		                         echo "<div class='item-price'><div class='pric_reg'><span>$</span>".number_format($rowprodtfechdata['product_regular_price'], 2)."</div></div>";
		                      	...
		                      	echo "<div class='item-price'><div class='pric_dis'><span>$</span>".number_format($rowprodtfechdata['product_regular_price'], 2)."</div> ";
		                        echo "<div class='pric_reg'><span>$</span>".$rowprodtfechdata['product_sale_price']."</div></div>";
		                    }
		                    if($stock == "0"){
			               		echo "<div class='item-cart'><button class='alert alert-danger unavailable'>Out of Stock</button></div>";
			               	}else{
			...
			echo "<div class='item'>
		            ...
		            echo "<a href='$url/$product_art_pageurl'>
		              ...
		              <div class='item-txt'>
		                ...
		                if($product_art_price == "0" || $product_art_price == ""){
		                	...
		                	if($rowprodtfechdataart['product_sale_price'] == ""){
	                         echo "<div class='item-price'><div class='pric_reg'><span>$</span>".number_format($rowprodtfechdataart['product_regular_price'], 2)."</div></div>";
		                        ...
		                        echo "<div class='item-price'><div class='pric_dis'><span>$</span>".number_format($rowprodtfechdataart['product_regular_price'], 2)."</div> <div class='pric_reg'><span>$</span>".number_format($rowprodtfechdataart['product_sale_price'], 2)."</div>";
		                        echo "</div>";
		                    }
			                if($stock == "0"){
			               	echo "<div class='item-cart'><button class='alert alert-danger unavailable'>Out of Stock</button></div>";
