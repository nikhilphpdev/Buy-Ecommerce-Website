              ...
              <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo $stauts; ?></td>
                      <td><?php echo USATimeZoneSettime($pagevale['page_date']); ?> / <?php echo $pagevale['page_time']; ?></td>
                      <td class="text-right py-0 align-middle">
                        <div class="btn-group btn-group-sm">
                          <a href="<?php echo $url; ?>/admin-manager/edit-page/?page-id=<?php echo $pagevale['id']; ?>&ut=<?php echo $pagevale['page_unqi_id']; ?>" class="btn btn-info"><i class="fa fa-pencil"></i></a>
                          <a href="<?php echo $url; ?>/admin-manager/all-pages/?page-id=<?php echo $pagevale['id']; ?>&ut=<?php echo $pagevale['page_unqi_id']; ?>" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                        </div>
                      </td>
                    </tr>
                    <?php } ?>
