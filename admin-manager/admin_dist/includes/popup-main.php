                  ...
                  <div class="col-md-3"> 
                    <div class="attachimg">
                      ...
                      <div id="load_demoshow">
                        <div class="row">
                          <div class="col-sm-3">
                            <img id="img_nameval" src="https://buyjee.com/new-design/images/1887800591.jpg" class="img-responsive">
                          </div>
                          <div class="col-sm-9">
                            <div class="rdis">
...
<div class="modal fade" id="resetpassword" tabindex="-1" role="dialog" aria-labelledby="resetpassword" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data" action="" id="passwordForm">
    <div class="modal-body">
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label>New Password:</label>
                     <div class="input-group mb-3" id="show_hide_new_password">
                    <input type="password" class="form-control" name="vend_newpass" id="newPassword" placeholder="New Password">
                 <div class="input-group-append">
                   <span class="input-group-text">
                      <a href="#" class="toggle-password" style="text-decoration: none;">
            ...
            <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="password" class="form-control" name="vend_newpass2" id="retypePassword" placeholder="Retype Password">
                  <div class="input-group-append">
                    <span class="input-group-text">
                      <a href="#" class="toggle-password" style="text-decoration: none;">
                        <i class="fa fa-eye-slash" aria-hidden="true"></i>
