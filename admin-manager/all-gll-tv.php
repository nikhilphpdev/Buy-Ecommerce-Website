...
if(isset($_GET['action']) && isset($_GET['delete']) && isset($_GET['id'])){
    ...
    if($delete_vale == true){
      echo "<script>alert('Successfully Deleted.');window.location.href='$url/admin-manager/all-gll-tv/?action=$getvale';</script>";
	}else{
                    ...
                    <tr id="<?php echo $slidrvalue['id']; ?>">
                      ...
                      <td class="text-right py-0 align-middle">
                        <div class="btn-group btn-group-sm">
                          ...
                          <a href="<?php echo $url; ?>/admin-manager/all-gll-tv/?action=<?php echo $_GET['action']; ?>&delete=action&id=<?php echo $slidrvalue['id']; ?>" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                        </div>
                      </td>
                    </tr>
                  <?php } ?>
