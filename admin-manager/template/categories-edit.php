                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="catogyvaldatavl" placeholder="Enter ..." required>
                      ...
                      <div class="form-group">
                        ...
                        <input type="submit" value="Add" name="catagoryaddnew" class="btn btn-success float-right">
