...
use PHPMailer\PHPMailer\SMTP;
   ...
   $to = $vendorInfo['email'];
 $name =$vendorInfo['first_name'];
 $lname =$vendorInfo['last_name'];
   $subject = "BuyJee Inquiry Approved ";
	                            ...
	                            <table border='0' cellpadding='0' cellspacing='0' width='100%'>
	                                ...
	                                <tr>
	                                    ...
	                                    <td style='color: #153643; font-family: Arial, sans-serif; font-size: 20px; padding-bottom: 5px;'>
	                                        ...
	                                        Congratulations <b> ".$name." ".$lname.",</b><br/><br/>
	                                ...
	                                <tr>
	                                    ...
	                                    <td style='padding: 0px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 30px;'>
	                                       ...
	                                       <b> Your request has been approved.</b> <br/><br/>

	                                        Use the temporary password below to log in, and don’t forget to set a new one - <a href='https://buyjee.com/login' target='_blank'>Login.</a><br/><br/>
                                              Your Password: <b>  ".$new_pass."</b><br/><br/>
