...
$explode_vale = explode('/seo-user/product_attitude-edit/?pagetype=edit&', $reqest_vale);
...
if(isset($_GET['pagetype'])){
    ...
    if($get_pagename == "delete"){
        ...
        if($delctval == true){
            echo "<script>alert('Successfully Delete');window.location.href='$url/seo-user/product_attitude-edit';</script>";
        }else{
            echo "<script>alert('Please Try Again');window.location.href='$url/seo-user/product_attitude-edit';</script>";
        }
    }
}else{
    $get_pagename = "";
...
if(isset($_POST['submitcater'])){
    ...
    if($insertdata == true){
        ...
        echo "<script>alert('Successfully');window.location.href='$url/seo-user/product_attitude';</script>";
