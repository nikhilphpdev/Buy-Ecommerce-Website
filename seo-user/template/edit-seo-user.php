            ...
            <div class="card-body">
              <form role="form" method="post" action="">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="seotitle">Password (If you have change password then type your new password.)</label>
                      <input type="text" class="form-control" placeholder="If you have change password then type your new password." name="updatepasswordvale">
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
