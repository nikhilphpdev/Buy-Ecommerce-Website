            ...
            <div class="card-body pad">
                ...
                <div class="row mb-3 align-items-right">                                    
                    ...
                    <div class="col-lg-12 col-md-12 mb-3 sdate">
                        ...
                        <input type="date" name="coupansdate" value="<?php echo $coupanvale['coup_s_date']; ?>" class="form-control" required>
                    ...
                    <div class="col-lg-12 col-md-12 mb-3 edate">
                        ...
                        <input type="date" name="coupanedate" value="<?php echo $coupanvale['coup_end_date']; ?>" class="form-control" required>
