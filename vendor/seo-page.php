...
/*$valeuset = get_seotitlekeywords($page_name);
echo'<pre>';print_r($valeuset);*/
/*if (!empty($valeuset)) {
   $set_vale_title = isset($valeuset['seo_title']) ? $valeuset['seo_title'] : '';
    $set_vale_decrtn = isset($valeuset['seo_desrpt']) ? $valeuset['seo_desrpt'] : '';
    $set_vale_keyword = isset($valeuset['seo_keyword']) ? $valeuset['seo_keyword'] : '';
    $set_vale_indeing = isset($valeuset['seo_indexing']) ? $valeuset['seo_indexing'] : '';
    $set_vale_img = isset($valeuset['seo_imageval']) ? $valeuset['seo_imageval'] : '';
} */
...
<div class="card-body">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="seotitle" value="<?php echo $set_vale_title; ?>" placeholder="Title" name="seotitle">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="seodescription" name="seodescription" placeholder="Description" value="<?php echo $set_vale_decrtn; ?>">
  </div>
  <div class="form-group">
    <label for="seokeywords">Keywords</label>
    <input type="text" class="form-control" id="seokeywords" name="seokeywords" placeholder="Keywords" value="<?php echo $set_vale_keyword; ?>">
  </div>
  <div class="form-group">
